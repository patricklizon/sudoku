...
import { type Config, _isRowAndColMinimumCellCountSatisfied } from './remove-cell-strategies';
...
// describe(removeGridCellsJumpingByOneCell.name, () => {
...
// 		expect(() => {
// 			removeGridCellsJumpingByOneCell(g, {
// 				minimumGivenCells: {
// 					col: 3,
// 					row: 3,
// 					total: {
...
// describe(removeGridCellsWanderingAlongS.name, () => {
// 	test.each<GridFilled[]>([
// 		[
// 			[
// 				2, 6, 7, 3, 1, 4, 5, 8, 9, 8, 9, 4, 2, 6, 5, 3, 1, 7, 5, 3, 1, 7, 9, 8, 4, 2, 6, 6, 2, 9, 1,
// 				4, 7, 8, 3, 5, 3, 4, 5, 9, 8, 2, 6, 7, 1, 1, 7, 8, 6, 5, 3, 2, 9, 4, 7, 5, 6, 8, 3, 1, 9, 4,
// 				2, 9, 1, 3, 4, 2, 6, 7, 5, 8, 4, 8, 2, 5, 7, 9, 1, 6, 3,
// 			],
// 			[
// 				6, 1, 4, 5, 2, 7, 3, 8, 9, 9, 7, 8, 1, 4, 3, 2, 6, 5, 3, 5, 2, 8, 6, 9, 7, 1, 4, 2, 4, 5, 6,
// 				3, 8, 1, 9, 7, 8, 3, 9, 7, 5, 1, 4, 2, 6, 1, 6, 7, 2, 9, 4, 5, 3, 8, 5, 8, 1, 9, 7, 2, 6, 4,
// 				3, 7, 9, 3, 4, 1, 6, 8, 5, 2, 4, 2, 6, 3, 8, 5, 9, 7, 1,
// 			],
// 			[
// 				3, 8, 7, 4, 6, 2, 9, 1, 5, 1, 4, 9, 3, 7, 5, 2, 8, 6, 2, 6, 5, 1, 9, 8, 4, 3, 7, 8, 2, 6, 5,
// 				3, 4, 7, 9, 1, 7, 9, 1, 8, 2, 6, 3, 5, 4, 4, 5, 3, 9, 1, 7, 6, 2, 8, 6, 1, 2, 7, 8, 3, 5, 4,
// 				9, 9, 3, 4, 6, 5, 1, 8, 7, 2, 5, 7, 8, 2, 4, 9, 1, 6, 3,
// 			],
// 		] as GridFilled[],
// 	])('removes cells for problematic config', (grid) => {
// 		expect(() =>
// 			removeGridCellsWanderingAlongS(grid, {
// 				minimumGivenCells: {
// 					col: 2,
// 					row: 2,
// 					total: {
